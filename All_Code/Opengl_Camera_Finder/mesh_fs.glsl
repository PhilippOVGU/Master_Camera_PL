...
//	vec3 view=vec3(50.0f,10.0f,30.0f); //kamera immer bei (0,0,0)
...
//	vec3 light = (vec3(10.0f,10.0f,1.0f)); //licht richtung --> ( uncoomment This  for arbaterry light position)
	...
	f_color=vec4(ambient+deffuse+0.05*specular,1.0f); // combination der einezlen effekte
